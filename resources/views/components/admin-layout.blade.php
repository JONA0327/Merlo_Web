                ...
                <nav class="flex-1 space-y-1 px-4 py-6">
                    ...
                    @if (auth()->user()->isSuperAdmin())
                        ...
                        <div class="pt-4 mt-4 border-t border-white/10">
                            ...
                            <a href="{{ route('admin.payment-methods.index') }}" class="flex items-center gap-3 rounded-xl px-4 py-2.5 text-sm font-semibold transition-colors {{ $active === 'payment-methods' ? 'bg-[#8C1D2B] text-white' : 'text-white/70 hover:bg-white/5 hover:text-white' }}">
